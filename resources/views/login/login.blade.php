	...
	<div class="form-container">
		...
		<form action="user" method="POST">
			...
			<div class="control">
				...
				<input type="text" name="user" id="user" class="form-control @error('email') is-invalid @enderror" placeholder="Username" autofocus required>
			</div>
			<div class="control">
				<label for="password">Password</label>
				<input type="password" name="password" id="password" placeholder="Password">
			</div>
			<!-- <small>Do you even have email ? lmao <a href="register" style="color: red;">click here</a></small> -->
